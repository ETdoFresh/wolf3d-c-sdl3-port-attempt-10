...
void SignonScreen(void)
{
    ...
    // In SDL3 port, the signon screen is drawn differently.
    // We just clear to the game palette colors for now.
    // The intro screen bitmap (introscn) is not linked in.
    VL_ClearVideo(0);
}
